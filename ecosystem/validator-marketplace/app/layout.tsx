        ...
        <nav className="border-b border-[#2a2a4a] bg-[#12121a]/80 backdrop-blur-md sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-6">
              <a href="#validators" className="text-sm text-[#9999bb] hover:text-white transition-colors">Validators</a>
              <a href="#my-stakes" className="text-sm text-[#9999bb] hover:text-white transition-colors">My Stakes</a>
              <button className="px-4 py-2 rounded-lg bg-gradient-to-r from-emerald-600 to-teal-600 text-white text-sm font-medium hover:opacity-90 transition-opacity">
                Connect Wallet
              </button>
            </div>
          </div>
